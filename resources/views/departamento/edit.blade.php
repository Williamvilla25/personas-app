...
<div class="container">
    ...
    @csrf
  <div class="mb-3">
    <label for="codigo" class="form-label">CId</label>
  ...
  <div class="mb-3">
    ...
    <input type="text" required class="form-control" id="name" placeholder="Deparmentname"
  ...
  <label for = "country">Country:</label>
    ...
    <option selected disabled value = "">Choose one...</option>
      @foreach ($paises as $pais)
       @if($departamento->pais_codi == $departamento->pais_codi)
